/*
  LCD5110_SSVS.h - Arduino/chipKit library support for Nokia 5110 compatible LCDs
...
#ifndef LCD5110_SSVS_h
#define LCD5110_SSVS_h
...
class LCD5110
{
	public:
		...
		void	print(char *st, int x, int y, int length=0, char filler=' ');
		void	print(String st, int x, int y, int length=0, char filler=' ');
